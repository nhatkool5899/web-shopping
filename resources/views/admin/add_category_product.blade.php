            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        <form action="{{URL::to('/save-category-product')}}" method="POST" class="form-horizontal" role="form">
                            {{ csrf_field() }}
                        <div class="form-group">
                            <label class="col-lg-3 col-sm-3 control-label">Tên danh mục</label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control" name="category_product_name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 col-sm-3 control-label">Mô tả danh mục</label>
                            <div class="col-lg-9">
                                <textarea style="resize: none" rows="5" class="form-control" name="category_product_desc" required></textarea>
                            </div>
                        </div>
                        <div class="form-group">
